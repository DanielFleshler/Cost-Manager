...
function createReportTable(props) {
    // ביצוע אגרגציה של הנתונים לפי קטגוריה
    ...
    // יצירת rows מהנתונים המאגרים
    // עכשיו rows מכיל את המידע הרצוי
    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center' }}>
            <TableContainer
                component={Paper}
                sx={{
                    width: '60%',  // Makes the table 60% of the container width
                    minWidth: '400px' // Ensures the table doesn't get too narrow
                }}
            >
